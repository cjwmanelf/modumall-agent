...
매뉴얼 전체를 프롬프트에 통째로 넣으면 토큰 낭비와 환각(예: 배송 문의에 반품 규정이 섞여 들어감)이 발생하므로, [`context.py`](file:///c:/Users/cjwma/OneDrive/바탕%20화면/modumall-agent/context.py)를 통해 각 분과에 꼭 필요한 조항만 동적으로 조립합니다.
